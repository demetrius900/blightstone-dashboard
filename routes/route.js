...
route.get('/creative-tracker', (req, res, next) => {
  res.render('creative-tracker', {title: 'Creative Tracker'});
})

route.get('/customer-avatars', (req, res, next) => {
  res.render('customer-avatars', {title: 'Customer Avatars'});
})

route.get('/competitor-analysis', (req, res, next) => {
  res.render('competitor-analysis', {title: 'Competitor Analysis'});
})
...
route.get('/documents', (req, res, next) => {
...
// Profile page disabled - access through topbar dropdown "My Account"
